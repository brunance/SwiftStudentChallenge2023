...
struct TextData {
    ...
    public static var aboutStepOneText: [TextData] = [
        ...
        .init(text: "In the following screen you'll have a little canvas to paint the floor of our game scene, just press the play button bellow to begin (END).", emotion: "happy"),
    ]
    ...
    public static var assetText: [TextData] = [
        ...
        .init(text: "If you're lost and want to read these instructions again, simply press this button one more time for me to repeat what I just said (END).", emotion: "happy"),
    ]
    ...
    public static var aboutStepTwoText: [TextData] = [
        ...
        .init(text: "Game objects can represent a wide range of things within a game, including characters, enemies, items, obstacles, and environmental elements (END).", emotion: "happy"),
    ]
    ...
    public static var gameObjText: [TextData] = [
        ...
        .init(text: "I'll add some to our character and see what happens... (END)", emotion: "happy"),
    ]
    ...
    public static var physicsOneText: [TextData] = [
        ...
        .init(text: "But if we add physics to it i'm pretty sure we can make this character stand on the ground (END).", emotion: "happy"),
    ]
    ...
    public static var physicsTwoText: [TextData] = [
        ...
        .init(text: "You can tap to add more of him in the scene, try it out it's quite fun (END).", emotion: "happy"),
    ]
    ...
    public static var aboutStepThreeText: [TextData] = [
        ...
        .init(text: "These are essential for creating immersive and engaging gameplay, let me show you how it looks (END).", emotion: "happy"),
    ]
    ...
    public static var movementText: [TextData] = [
        ...
        .init(text: "and there we have it, a nice little sprite with animation, physics and movement (END).", emotion: "happy"),
    ]
